...
public class LogicNode {
    ...
    public void addPositionCondition(DriveTrain drive, double tolerance, Pose nextPose, LogicNode nextNode){
    ...
    public void addPositionCondition(DriveTrain drive, double tolerance, Pose nextPose, Runnable preTransitionMethod ,LogicNode nextNode){
        conditionsList.add(new AutoIf(
                ()->drive.reachedTarget(tolerance),
                ()->{
                    drive.setTargetPose(nextPose);
